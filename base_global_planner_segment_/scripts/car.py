...
WB = 3.  # distance from rear to front wheel
W = 2.  # width of a car
LF = 3.3  # distance from rear to vehicle front end
LB = 1.0  # distance from rear to vehicle back end
MAX_STEER = 0.6  # [rad] maximum steering angle of the car
...
# vehcile's dimension during plotting the car along the occupancy grid and waypoints
VRX = [LF, LF, -LB, -LB, LF]
...
##Plot the orientation of the car while traversing
...
##A function to plot to the Car'pose and orientation given x,y,yaw
