...
if __name__ == '__main__':
    try:
        ...
        heartbeat_monitor_node = HeartbeatMonitorNode('/home/infy/Desktop/FieldRobots/navigation_ws/src/base_trajectory/base_trajectory_interface/src/base_global_planner_segment_/config/topics.yaml')  # Replace with the path to your topics.yaml file
