...
class Path:
    ...
    def __init__(self):
        self.lengths = [] #Length of the path
        self.ctypes = []  # Configuration type
        self.L = 0.0    
        self.x = []
        self.y = []
        self.yaw = []
        self.directions = [] #Directions to be taken

#a function to plot an arrow to indicate the orientation of the car
...
#Straight left straight configuration; To compute curve path for +/- yaw angle
